...
\usepackage{booktabs}
\usepackage{stfloats}
% hyperref last, after cite, so it can patch the citation commands rather than
% be patched over. hidelinks keeps the coloured frames out of the print copy.
...
Cairo, Egypt \\
\href{mailto:mohamedwbadra@gmail.com}{mohamedwbadra@gmail.com} \\
Code: \href{https://github.com/MWBadra/quote-grounded-lineup-prediction}{\texttt{github.com/MWBadra/quote-grounded-lineup-prediction}}}
}
